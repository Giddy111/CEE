  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.res == "success") {
        Swal.fire(
          "Success",
          "Selected Course is successfully deleted",
          "success"
        );
        refreshDiv();
      }
  ...
  $.post(
    ...
    function (data) {
      ...
      if (data.res == "noDisplayLimit") {
        ...
        Swal.fire(
          "Already Exists",
          data.examTitle.toUpperCase() + "<br>Already Exists",
          "error"
        );
      } else if (data.res == "success") {
        Swal.fire(
  ...
  $.post(
    ...
    function (data) {
      if (data.res == "exist") {
        Swal.fire(
          "Already Exists",
          data.msg + " question <br>already exists in this exam",
          "error"
        );
      } else if (data.res == "success") {
        Swal.fire(
  ...
  $.post(
    ...
    function (data) {
      if (data.res == "noGender") {
        ...
        Swal.fire("Email Already Exist", data.msg + " already exist", "error");
      } else if (data.res == "success") {
        Swal.fire(
          "Success",
